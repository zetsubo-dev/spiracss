// SpiraCSS Configuration for Next Global Example
...
const config = {
  ...
  // JSX / TSX className extraction (global CSS usage)
  jsxClassBindings: {
    // Prefer plain string className; disable member access extraction.
    memberAccessAllowlist: []
  },
