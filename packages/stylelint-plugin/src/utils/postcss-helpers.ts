...
export const isRule = (node: Node | null | undefined): node is Rule => Boolean(node && node.type === 'rule')
export const isAtRule = (node: Node | null | undefined): node is AtRule => Boolean(node && node.type === 'atrule')
export const isComment = (node: Node | null | undefined): node is Comment => Boolean(node && node.type === 'comment')
